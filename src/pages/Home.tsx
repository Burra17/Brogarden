    ...
    <>
      ...
      <section className="relative h-hero-home flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 text-center text-white pt-20 pb-12 md:py-0">
          ...
          <p className="hero-animate hero-delay-1 text-base md:text-2xl max-w-3xl mx-auto mb-8 md:mb-10 font-medium leading-relaxed drop-shadow-[0_2px_8px_rgba(0,0,0,0.6)]">
            Lägergård, vandrarhem och EFS-kyrka i lugn och naturskön miljö nära
            havet. En plats för vila, gemenskap och glädje.
          </p>
      ...
      <section className="py-20 bg-white">
        <div className="hero-animate hero-delay-2 container mx-auto px-4 max-w-4xl text-center">
          <span className="text-[#4A6741] font-bold tracking-wider uppercase text-sm mb-2 block">
            Om Oss
          </span>
          ...
          <p className="text-lg text-gray-700 leading-relaxed mb-12">
            Brogården drivs ideellt av en lokal, kristen EFS-förening. Här
            erbjuds prisvärt boende i rum och stugor samt ställplatser för
            husbil och tält. Gården används även för läger, dop, bröllop,
            föreningsdagar och gudstjänster.
          </p>
          ...
          >
            <div className="p-6 bg-[#fcfaf7] rounded-xl border border-gray-100 shadow-sm">
              ...
              <p className="text-gray-600 text-sm">
                Omgiven av skog och vatten, perfekt för återhämtning.
              </p>
            </div>
            <div className="p-6 bg-[#fcfaf7] rounded-xl border border-gray-100 shadow-sm">
              ...
              <p className="text-gray-600 text-sm">
                Enkla, mysiga rum och stugor med personlig touch.
              </p>
            </div>
            <div className="p-6 bg-[#fcfaf7] rounded-xl border border-gray-100 shadow-sm">
              ...
              <p className="text-gray-600 text-sm">
                En mötesplats för alla åldrar, driven av ideella krafter.
              </p>
            </div>
          </div>
        </div>
      ...
      <div
        ref={collageRef}
        className="reveal-stagger grid grid-cols-2 md:grid-cols-4 h-64 md:h-96 w-full bg-white"
      >
        {[1, 2, 3, 4].map((num) => (
          <div
            key={num}
