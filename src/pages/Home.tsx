        ...
        <>
            ...
            <section className="relative h-screen flex items-center justify-center overflow-hidden">
                ...
                <div className="absolute inset-0 z-0">
                    ...
                    />
                    {/* Minskat från bg-black/40 till bg-black/0 för klarare bild */}
                    <div className="absolute inset-0 bg-black/0"></div>
                </div>

                {/* Content */}
                <div className="relative z-10 container mx-auto px-4 text-center text-white">
                    {/* Ökat drop-shadow till 2xl för bättre kontrast mot ljusare bild */}
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link
                            to="/boende"
                            className="px-8 py-4 bg-brand-lightGreen hover:bg-green-600 text-white font-semibold rounded-full transition-all transform hover:scale-105 shadow-lg flex items-center justify-center gap-2 drop-shadow-md"
                        >
                            Se våra rum & stugor <ArrowRight size={20} />
                        </Link>
                        <Link
                            to="/kontakt"
                            className="px-8 py-4 bg-white/10 backdrop-blur-md hover:bg-white/20 text-white border border-white/50 font-semibold rounded-full transition-all flex items-center justify-center drop-shadow-md"
                        >
                            Kontakta oss
                        </Link>
                    </div>
